...
2.   SVM's & Softmax
3.   Learning rate schedules: SGD, SGD+Momentum, Adagrad, RMSProp, Adam
4.   Vanishing gradients on sigmoids & Backprop ReLUs
    a. [Original Word2Vec Paper](https://arxiv.org/pdf/1301.3781.pdf)
    b. [Negative Sampling Paper](https://proceedings.neurips.cc/paper_files/paper/2013/file/9aa42b31882ec039965f3c4923ce901b-Paper.pdf)
5.   Dependency parsing, Regularization, n-gram, RNN's 
